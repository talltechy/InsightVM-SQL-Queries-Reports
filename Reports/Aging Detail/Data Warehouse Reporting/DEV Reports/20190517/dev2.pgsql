...
FROM fact_asset_vulnerability_instance favi
    JOIN vuln_references vr ON favi.vulnerability_id = vr.vulnerability_id
    JOIN dfa_assets dfa ON favi.asset_id = dfa.asset_id
--end FROM/JOIN
WHERE dfa.asset_group_id = 2
ORDER BY favi.asset_id, dfa.ip, vr.severity DESC;
