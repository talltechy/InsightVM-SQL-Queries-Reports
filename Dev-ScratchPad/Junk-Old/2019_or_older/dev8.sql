...
,to_char(fava.first_discovered,'MM/DD/YYYY') AS discovered_date
...
JOIN fact_asset_vulnerability_age fava  (favf.asset_id, favf.vulnerability_id)
...
ORDER BY "Hostname", "Vulnerability ID"